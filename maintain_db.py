...
def main():
    parser = argparse.ArgumentParser(description="Database maintenance for Meshtastic Discord Bridge Bot")
    ...
    parser.add_argument("--node-info", metavar="NAME", help="Show detailed info for node with given name")
